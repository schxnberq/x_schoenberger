            ...
            (function ($, undefined) {
                    ...
                    function nextImage() {
                        ...
                        $('.overlay__cnt').animate({
                            ...
                            var $last_src = $(".gallery__cnt__thmb a[data-idx='" + next_idx + "']").attr("href");
                    ...
                    function prevImage() {
                        ...
                        var $first_src = $(".gallery__cnt__thmb a[data-idx='" + prev_idx + "']").attr("href");
                    ...
                    $(".overlay__next").on('click', function () {
                        next_idx++;
                        if(next_idx == thmbs.length) {
                            next_idx = 0;
                        }
                        console.log("click " + next_idx);
                        nextImage();
                    });
                    ...
                    $(".overlay__prev").on('click', function () {
                        prev_idx--;
                        if(prev_idx == -1) {
                            prev_idx = thmbs.length-1;
                        }
                        console.log("click " + prev_idx);
                        prevImage();
                    });
